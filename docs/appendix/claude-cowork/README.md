...
Die bereitgestellten Cowork-Quellen bleiben unverändert erhalten. v3 ist die
aktuelle Dokumentationsgrundlage; v2 bleibt zur Nachvollziehbarkeit des
Zwischenstands archiviert.

| Datei | Rolle | SHA-256 |
|---|---|---|
| `Projektkontext_OnboardingandProjectPages_v3_utf8bom.md` | aktueller Projektkontext | `4a87c37453948a355e1f67d77f787316680205c0b85d4b414b7f6065222f0177` |
| `Projektkontext_LinksundErreichbarkeit_v3_utf8bom.md` | aktuelle Link- und Erreichbarkeitsmatrix | `1a5d1bf58a011959c2252593d92b35b138acbd701183d4cfe1fad663606f9788` |
...
| `Projektkontext_OnboardingandProjectPages_v2_utf8bom.md` | archivierter Zwischenstand | `47f25ed6cee1fa28c4a364d4e7a86c81cb26b3d77f861fb60578e6dbda456e1c` |
